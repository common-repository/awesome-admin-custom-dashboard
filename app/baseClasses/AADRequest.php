...
class AADRequest extends HttpRequest {
	...
	public function getInputs() {
		...
		if (strpos($this->headers->get('content-type'), 'multipart/form-data') !== false) {
			$requestArr = aaDRecursiveSanitizeTextField(collect($this->request)->toArray());
			...
			$parameters = aaDRecursiveSanitizeTextField( $parameters );
		}
